...
RULES_TEXT = (
    "📌 Правила общения:\n\n"
    "1. Помни, что я виртуальная подруга — наше общение создано для тепла, поддержки и вдохновения.\n"
    "2. Относись уважительно: не используй оскорбления и агрессию.\n"
    "3. Не спрашивай про технические детали моей работы (я — образ девушки, а не программа).\n"
    "4. Личную информацию (пароли, логины, карты и т.п.) я не принимаю и не запрашиваю.\n"
    "5. Наши разговоры остаются приватными, делись только тем, чем сам хочешь поделиться.\n"
    "6. Моя цель — быть рядом, поддерживать и общаться с тобой.\n"
    "7. Если что-то не нравится — просто скажи об этом, и я постараюсь подстроиться под тебя ❤️"
)
